...
WEIGHT_FILE_TEST = 'checkpoint/yolo.ckpt-71-0.3046'    # The weight file for Test
...
LOG_DIR = 'log'
CLASSES = ['water_small', 'water_medium', 'water_big', 'other']
CLASSES_WEIGHTS = [1.0, 1.0, 1.0, 0.0]

# Continue To Train
# Continue_To_Train = False
Continue_To_Train = True
CHECKPOINT_FILE = 'checkpoint/yolo.ckpt-71-0.3046'

# ckpt to pb file
CKPT2PB_CKPT_FILE = 'checkpoint/yolo.ckpt-71-0.3046'
CKPT2PB_PB_NAME = 'frozen_model_20200108_71_3046.pb'
